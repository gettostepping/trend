    ...
    <CursorPrimitive asChild {...props}>
      <svg
        ...
        style={{ 
          ...
          width: '24px',
          height: '24px',
          // Offset so the tip (at ~2px, 4px in viewBox) aligns with mouse position
...
function CursorFollow({
  ...
  // If children is already a single element with className, use it directly
  if (React.isValidElement(children) && children.type === 'div' && className) {
    return (
